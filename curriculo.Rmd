...
# Perfil
* Economista de formação e cientista de dados por destino. Acredita na filosofia *long life learning* e que a principal *soft skill* de *data science* é *storytelling*. Agnóstico  sobre ferramenta e linguagem. Nas horas vagas reveza entre o muay thai e o *ifood*.

# Habilidades 

```{r}
theme_set(theme_bw())
my.df1 <- data.frame(c("R", "SQL", "Power BI","Python", "MLOps"), c(4.5,4.5,4,3.5,3.5))
names(my.df1) <- c("Skill","Nivel")
my.df1 <- my.df1[order(my.df1$Nivel), ]  # sort
my.df2 <- data.frame(c("Séries temporais", "Supervisionado", "Não supervisionado","Deep Learning", "NLP"), c(4.5,4,4,2,1))
